<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="incidentes.aspx.cs" Inherits="mantenimiento1.incidentes" %>
    ...
    <form id="form1" runat="server">
        <div>
            <asp:Panel ID="Panel1" runat="server">
                <asp:Label ID="Label1" runat="server" Text="Tipo de Incidente"></asp:Label>
                &nbsp;<asp:TextBox ID="txttipo" runat="server"></asp:TextBox>
                <br />
                <asp:Label ID="Label2" runat="server" Text="Descripcion"></asp:Label>
                &nbsp;<asp:TextBox ID="txtdescripcion" runat="server"></asp:TextBox>
                <br />
                <asp:Label ID="Label3" runat="server" Text="Gasto"></asp:Label>
                &nbsp;<asp:TextBox ID="txtgasto" runat="server"></asp:TextBox>
                <br />
                <asp:Label ID="Label4" runat="server" Text="Fecha de Incidente"></asp:Label>
                &nbsp;<asp:TextBox ID="txtfincidente" runat="server"></asp:TextBox>
                &nbsp;<asp:Button ID="Button1" runat="server" OnClick="Button1_Click" Text="Calendario" />
                <br />
                <asp:Calendar ID="Calendar1" runat="server" OnSelectionChanged="Calendar1_SelectionChanged" Visible="False"></asp:Calendar>
                <br />
                <asp:Label ID="Label5" runat="server" Text="ID Conductor"></asp:Label>
                &nbsp;<asp:TextBox ID="txtidcond" runat="server"></asp:TextBox>
                <br />
                ...
                <br />
                <asp:Label ID="Label8" runat="server" Text="Buscar Codigo"></asp:Label>
                &nbsp;<asp:TextBox ID="txtbuscar" runat="server"></asp:TextBox>
                &nbsp;<asp:Button ID="Button7" runat="server" OnClick="Button7_Click" Text="Buscar" />
                <br />
                <asp:GridView ID="tabla" runat="server" Width="587px">
                </asp:GridView>
            </asp:Panel>
        </div>
    </form>
