<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="repuestos.aspx.cs" Inherits="mantenimiento1.repuestos" %>
    ...
    <form id="form1" runat="server">
        <div>
            <asp:Panel ID="Panel1" runat="server">
                <asp:Label ID="Label1" runat="server" Text="Código de Repuesto"></asp:Label>
                ...
                &nbsp;<asp:RadioButton ID="rb_disponible" runat="server" GroupName="estado" Text="Disponible" />
                &nbsp;<asp:RadioButton ID="rb_nodisponible" runat="server" GroupName="estado" Text="No disponible" />
                &nbsp;<asp:TextBox ID="txtestado" runat="server" Visible="False"></asp:TextBox>
                <br />
                <asp:Label ID="Label6" runat="server" Text="Tipo de Material"></asp:Label>
                ...
                <br />
                <asp:Label ID="Label8" runat="server" Text="ID Mantenimiento"></asp:Label>
                &nbsp;<asp:TextBox ID="txtid_mant" runat="server"></asp:TextBox>
                <br />
                ...
                &nbsp;<asp:Button ID="Button5" runat="server" OnClick="Button5_Click" Text="Calendario" />
                <br />
&nbsp;<asp:Calendar ID="Calendar1" runat="server" OnSelectionChanged="Calendar1_SelectionChanged" Visible="False"></asp:Calendar>
                ...
                <br />
                <asp:Label ID="Label11" runat="server" Text="Digitar Codigo"></asp:Label>
                &nbsp;<asp:TextBox ID="txtbuscar" runat="server"></asp:TextBox>
                &nbsp;<asp:Button ID="Button6" runat="server" OnClick="Button6_Click" Text="Buscar" />
                <br />
                <asp:GridView ID="tabla" runat="server" Width="657px">
                </asp:GridView>
            </asp:Panel>
        </div>
    </form>
