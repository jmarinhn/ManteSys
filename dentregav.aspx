<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="dentregav.aspx.cs" Inherits="mantenimiento1.dentregav" %>
    ...
    <form id="form1" runat="server">
        <div>
            <asp:Panel ID="Panel1" runat="server">
                <asp:Label ID="Label1" runat="server" Text="Fecha Recepcion"></asp:Label>
                &nbsp;<asp:TextBox ID="txtfrecepcion" runat="server"></asp:TextBox>
                &nbsp;<asp:Button ID="Button1" runat="server" OnClick="Button1_Click" Text="Calendario" />
                <br />
                <asp:Calendar ID="Calendar1" runat="server" OnSelectionChanged="Calendar1_SelectionChanged" Visible="False"></asp:Calendar>
                <br />
                <asp:Label ID="Label2" runat="server" Text="ID Vehiculo"></asp:Label>
                &nbsp;<asp:TextBox ID="txtidvehiculo" runat="server"></asp:TextBox>
                <br />
                <asp:Label ID="Label3" runat="server" Text="ID Conductor"></asp:Label>
                ...
                &nbsp;<asp:Button ID="Button6" runat="server" Text="Eliminar" OnClick="Button6_Click" />
                <br />
                <asp:Label ID="Label6" runat="server" Text="Buscar Codigo"></asp:Label>
                &nbsp;<asp:TextBox ID="txtbuscar" runat="server"></asp:TextBox>
                &nbsp;<asp:Button ID="Button7" runat="server" OnClick="Button7_Click" Text="Buscar" />
                <br />
                <asp:GridView ID="tabla" runat="server" Width="527px">
                </asp:GridView>
            </asp:Panel>
        </div>
    </form>
