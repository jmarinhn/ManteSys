<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="detalleconsumo.aspx.cs" Inherits="mantenimiento1.detalleconsumo" %>
    ...
    <form id="form1" runat="server">
        <div>
            <asp:Panel ID="Panel1" runat="server">
                <asp:Label ID="Label1" runat="server" Text="ID Vehiculo"></asp:Label>
                &nbsp;<asp:TextBox ID="txtidvehiculo" runat="server"></asp:TextBox>
                <br />
                <asp:Label ID="Label2" runat="server" Text="ID Conductor"></asp:Label>
                &nbsp;<asp:TextBox ID="txtidconductor" runat="server"></asp:TextBox>
                <br />
                <asp:Label ID="Label3" runat="server" Text="Nombre Comb"></asp:Label>
                &nbsp;<asp:TextBox ID="txtnombrecomb" runat="server"></asp:TextBox>
                <br />
                <asp:Label ID="Label4" runat="server" Text="Cantidad"></asp:Label>
                &nbsp;<asp:TextBox ID="txtcantidad" runat="server"></asp:TextBox>
                <br />
                <asp:Label ID="Label5" runat="server" Text="Fecha de Consumo"></asp:Label>
                &nbsp;<asp:TextBox ID="txtfechaconsumo" runat="server"></asp:TextBox>
                &nbsp;<asp:Button ID="Button1" runat="server" OnClick="Button1_Click" Text="Calendario" />
                <br />
                <asp:Calendar ID="Calendar1" runat="server" OnSelectionChanged="Calendar1_SelectionChanged" Visible="False"></asp:Calendar>
                <br />
                <asp:Label ID="Label6" runat="server" Text="Nombre de Estacion"></asp:Label>
                &nbsp;<asp:TextBox ID="txtnombreestacion" runat="server"></asp:TextBox>
                <br />
                ...
                <br />
                <asp:Label ID="Label9" runat="server" Text="Buscar Codigo"></asp:Label>
                &nbsp;<asp:TextBox ID="txtbuscar" runat="server"></asp:TextBox>
                &nbsp;<asp:Button ID="Button7" runat="server" OnClick="Button7_Click" Text="Buscar" />
                <br />
                <asp:GridView ID="tabla" runat="server" Width="504px">
                </asp:GridView>
            </asp:Panel>
        </div>
    </form>
