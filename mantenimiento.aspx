<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="mantenimiento.aspx.cs" Inherits="mantenimiento1.mantenimiento" %>
    ...
    <form id="form1" runat="server">
        <div>
            <asp:Panel ID="Panel1" runat="server">
                ...
                <br />
                <asp:Label ID="Label2" runat="server" Text="Fecha de Mantenimiento"></asp:Label>
                &nbsp;<asp:TextBox ID="txtfechamant" runat="server"></asp:TextBox>
                &nbsp;<asp:Button ID="Button6" runat="server" OnClick="Button6_Click" Text="Calendario" />
                <br />
                <asp:Calendar ID="Calendar1" runat="server" OnSelectionChanged="Calendar1_SelectionChanged" Visible="False"></asp:Calendar>
                <br />
                <asp:Label ID="Label3" runat="server" Text="Próximo Mantenimiento"></asp:Label>
                &nbsp;<asp:TextBox ID="txtproximo" runat="server"></asp:TextBox>
                &nbsp;<asp:Button ID="Button8" runat="server" OnClick="Button8_Click" Text="Calendario" />
                <br />
                ...
                <br />
                <asp:Label ID="Label6" runat="server" Text="ID Vehiculo"></asp:Label>
                &nbsp;<asp:TextBox ID="txtid_vehiculo" runat="server"></asp:TextBox>
                <br />
                <asp:Label ID="Label7" runat="server" Text="ID Taller"></asp:Label>
                &nbsp;<asp:TextBox ID="txtid_taller" runat="server"></asp:TextBox>
                <br />
                ...
                &nbsp;<asp:Button ID="Button7" runat="server" OnClick="Button7_Click" Text="Calendario" />
                <br />
                ...
                &nbsp;<asp:Button ID="Button2" runat="server" OnClick="Button2_Click" Text="Refrescar" />
                ...
                <br />
                <br />
                <asp:Label ID="Buscar" runat="server" Text="Digitar Código"></asp:Label>
                &nbsp;<asp:TextBox ID="txtbuscar" runat="server"></asp:TextBox>
                &nbsp;<asp:Button ID="Button5" runat="server" OnClick="Button5_Click" Text="Buscar" />
                <br />
                <asp:GridView ID="tabla" runat="server" style="margin-right: 2px" Width="667px">
                </asp:GridView>
            </asp:Panel>
        </div>
    </form>
