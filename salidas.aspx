<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="salidas.aspx.cs" Inherits="mantenimiento1.salidas" %>
    ...
    <form id="form1" runat="server">
        <div>
            <asp:Panel ID="Panel1" runat="server">
                <asp:Label ID="Label1" runat="server" Text="Lugar de Salida"></asp:Label>
                &nbsp;<asp:TextBox ID="txtlsalida" runat="server"></asp:TextBox>
                <br />
                <asp:Label ID="Label2" runat="server" Text="Lugar de Destino"></asp:Label>
                &nbsp;<asp:TextBox ID="txtldestino" runat="server"></asp:TextBox>
                <br />
                <asp:Label ID="Label3" runat="server" Text="Numero de Personas"></asp:Label>
&nbsp;<asp:TextBox ID="txtnpersonas" runat="server"></asp:TextBox>
                <br />
                ...
                &nbsp;<asp:TextBox ID="txtfsalida" runat="server"></asp:TextBox>
                &nbsp;<asp:Button ID="Button1" runat="server" OnClick="Button1_Click" Text="Calendario" />
                <br />
                <asp:Calendar ID="Calendar1" runat="server" OnSelectionChanged="Calendar1_SelectionChanged" Visible="False"></asp:Calendar>
                <br />
                <asp:Label ID="Label7" runat="server" Text="Fecha Retorno"></asp:Label>
                &nbsp;<asp:TextBox ID="txtfretorno" runat="server"></asp:TextBox>
                ...
                <br />
                <asp:Label ID="Label8" runat="server" Text="ID Conductor"></asp:Label>
                &nbsp;<asp:TextBox ID="txtid_conductor" runat="server"></asp:TextBox>
                <br />
                <asp:Label ID="Label9" runat="server" Text="ID Vehiculo"></asp:Label>
                ...
                &nbsp;<asp:Button ID="Button3" runat="server" OnClick="Button3_Click" Text="Calendario" />
                <br />
                ...
                &nbsp;<asp:Button ID="Button5" runat="server" Text="Refrescar" />
                ...
                <br />
                <asp:Label ID="Label12" runat="server" Text="Buscar Codigo"></asp:Label>
                &nbsp;<asp:TextBox ID="txtbuscar" runat="server"></asp:TextBox>
                &nbsp;
                <asp:Button ID="Button8" runat="server" OnClick="Button8_Click" Text="Buscar" />
                <br />
                <asp:GridView ID="tabla" runat="server" Width="638px">
                </asp:GridView>
            </asp:Panel>
        </div>
    </form>
